...
<body>
    ...
    <header id="main-header" class="py-3 bg-primary">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="text-white"><i class="fas fa-user"></i>Blogen Admin UI</h1>
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-block">
                        <form method="POST">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-block mb-3" name="login" type="submit">Login</button>
                            </div>
                        </form>
                        <?php
                                    if(isset($_POST['login'])){
                                        ...
                                        $result = login($useremail, $userpassword);
                                    }
                                ?>
                    </div>
                </div>
